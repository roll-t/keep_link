Map<String, String> vi = {
  ...
  "Settings": 'Cài đặt',
  "Avatar": 'Ảnh đại diện',
  "View Avatar": 'Xem ảnh đại diện',
  "Change Avatar": 'Đổi ảnh đại diện',
  "Choose photo from device": 'Chọn ảnh trên máy',
  "Choose avatar frame": 'Chọn khung ảnh đại diện',
  "Decorate avatar": 'Chọn trang trí ảnh đại diện',
  "Feature in development": 'Tính năng đang được phát triển',
  "No avatar available": 'Chưa có ảnh đại diện',
  "Switch Account": 'Chuyển tài khoản',
  "Add Account": 'Thêm tài khoản',
  "Add Another Account": 'Thêm tài khoản khác',
  "Active": 'Đang hoạt động',
  "Switch": 'Chuyển',
  "Remove from device": 'Xóa khỏi máy',
  "Switch to this account?": 'Chuyển sang tài khoản này?',
  "Switched to account": 'Đã chuyển sang tài khoản',
  "No saved accounts": 'Chưa có tài khoản nào được lưu',
  ...
  "Choose Add Friend Method": 'Chọn cách thêm bạn',
  "Friends & Shared": 'Bạn bè & Chia sẻ',
  "Friends & Requests": 'Bạn bè & Lời mời',
  "Friends Directory": 'Danh bạ bạn bè',
  "My QR Code": 'Mã QR của tôi',
  "My Friend Link": 'Link kết bạn của tôi',
  "Shared": 'Được chia sẻ',
  "Categories shared with you": 'Danh mục được chia sẻ',
  "Shared with you": 'Được chia sẻ với bạn',
  "shared_categories_count": 'danh mục được chia sẻ',
  "Search categories, links...": 'Tìm kiếm danh mục, liên kết...',
  "You can add friends by Gmail or personal link.":
      'Bạn có thể thêm bạn qua Gmail hoặc link cá nhân.',
  ...
  "requests_pending": 'lời mời đang chờ',
  ...
  "friend_invalid_email": 'Vui lòng nhập đúng địa chỉ Gmail',
  ...
  "friend_request_preview_title": 'Gửi lời mời kết bạn?',
  ...
  "QR Color": 'Màu sắc QR',
  "Eye Shape": 'Kiểu viền góc',
  "Dots Style": 'Kiểu điểm chấm',
  "Card Background": 'Nền thẻ QR',
  "Dark Carbon": 'Tối giản Dark',
  "Clean Light": 'Sáng thanh lịch',
  "Aurora": 'Cực quang',
  "Dots": 'Chấm tròn',
  "Circle": 'Tròn',
  "Square": 'Vuông',
  "Scan to connect on KeepLink": 'Quét để kết bạn trên KeepLink',
  "KeepLink Friend QR": 'Mã QR kết bạn KeepLink',
  "Save QR": 'Lưu QR',
  ...
  "Add to Category": 'Thêm vào danh mục',
  "Change Category": 'Chuyển danh mục',
  "Remove from Category": 'Xóa khỏi danh mục',
  "Create New Category": 'Tạo danh mục mới',
  "category_changed": 'Đã chuyển sang danh mục @name',
  "category_removed": 'Đã xóa khỏi danh mục',
  "No categories available": 'Chưa có danh mục nào',
  "Folder": 'Thư mục',
  "Add this post to a category": 'Thêm bài đăng này vào một thư mục',
  "Tap to move to another category": 'Chạm để chuyển sang danh mục khác',
  ...
  "Open in @app": 'Mở trong @app',
  "Open Website": 'Mở website',
  "Open Incognito": 'Mở ẩn danh',
  "Open with Incognito": 'Mở với ẩn danh',
  "Incognito Mode": 'Chế độ ẩn danh',
  "Incognito": 'Ẩn danh',
  "incognito_desc": 'Không lưu lịch sử & cookie',
  ...
  "Google sign in cancelled": 'Đã hủy đăng nhập Google',
  "Signed in successfully": 'Đăng nhập thành công',
  "Signed out successfully": 'Đăng xuất thành công',
  "Sign in failed, please try again": 'Đăng nhập thất bại, vui lòng thử lại',
  "Sign out failed, please try again": 'Đăng xuất thất bại, vui lòng thử lại',
  "sign_out_confirm":
      'Đăng xuất? Dữ liệu trên máy này sẽ bị xoá (đã được lưu vào tài khoản của bạn).',
  "Edit Username": 'Chỉnh sửa tên người dùng',
  ...
  // Feedback
  "Feedback & Bug Report": 'Góp ý & Báo lỗi',
  "Feedback": 'Góp ý',
  "Bug Report": 'Báo lỗi',
  "Sign in to send feedback": 'Đăng nhập để gửi góp ý & báo lỗi',
  "Share your thoughts, suggestions, or ideas...":
      'Chia sẻ suy nghĩ, đề xuất hoặc ý tưởng của bạn...',
  "Describe the bug, steps to reproduce, and expected behavior...":
      'Mô tả lỗi, các bước tái hiện và hành vi mong muốn...',
  "Today you can send only 1 feedback. Please try again tomorrow.":
      'Hôm nay bạn chỉ có thể gửi 1 góp ý. Vui lòng thử lại vào ngày mai.',
  "Today you can send only 3 bug reports. Please try again tomorrow.":
      'Hôm nay bạn chỉ có thể gửi 3 báo lỗi. Vui lòng thử lại vào ngày mai.',
  "Your message...": 'Nội dung của bạn...',
  "Describe the issue...": 'Mô tả vấn đề...',
  "Feedback sent. Thank you!": 'Đã gửi góp ý. Cảm ơn bạn!',
  "Bug report sent. Thank you!": 'Đã gửi báo lỗi. Cảm ơn bạn!',
  "Please sign in to send feedback.": 'Vui lòng đăng nhập để gửi góp ý.',
  ...
  "privacy.info_collect.body":
      '• Thông tin tài khoản: tên, email và ảnh đại diện khi bạn đăng nhập bằng Google.\n'
      '• Nội dung người dùng: link và danh mục bạn lưu trong ứng dụng.\n'
      '• Thông tin thiết bị: phiên bản ứng dụng, hệ điều hành và loại thiết bị cho mục đích phân tích.',
  "privacy.usage.title": 'Cách chúng tôi sử dụng thông tin',
  "privacy.usage.body":
      '• Đồng bộ link và danh mục đã lưu giữa các thiết bị qua Firebase.\n'
      '• Xác định tài khoản và cá nhân hóa trải nghiệm của bạn.\n'
      '• Cải thiện hiệu năng ứng dụng và khắc phục lỗi.',
  ...
  "privacy.third_party.body":
      ...
      '• Google Sign-In - để xác thực.\n'
      '• Firebase - để đồng bộ đám mây và phân tích.\n'
      'Các dịch vụ này có chính sách quyền riêng tư riêng.',
  ...
  "share_link_success": 'Đã chia sẻ liên kết cho bạn bè',
  "unshare_link_success": 'Đã gỡ chia sẻ liên kết',
  "share_link_failed": 'Không thể chia sẻ liên kết',
  "share_sign_in_required": 'Vui lòng đăng nhập để chia sẻ',
