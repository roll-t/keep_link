...
class _TermsContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        _Section(
          title: 'terms.acceptance.title'.tr,
          body: 'terms.acceptance.body'.tr,
        ),
        _Section(title: 'terms.use.title'.tr, body: 'terms.use.body'.tr),
        _Section(
          title: 'terms.content.title'.tr,
          body: 'terms.content.body'.tr,
        ),
        _Section(
          title: 'terms.account.title'.tr,
          body: 'terms.account.body'.tr,
        ),
        _Section(
          title: 'terms.disclaimer.title'.tr,
          body: 'terms.disclaimer.body'.tr,
        ),
        _Section(
          title: 'terms.liability.title'.tr,
          body: 'terms.liability.body'.tr,
        ),
        _Section(
          title: 'terms.changes.title'.tr,
          body: 'terms.changes.body'.tr,
        ),
