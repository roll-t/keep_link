            ...
            children: [
              ...
              Expanded(
                child: SingleChildScrollView(
                  padding: const EdgeInsets.symmetric(horizontal: 16), // Padding cho phần cuộn
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      ...
                      DestinationCard(),
                      const SizedBox(height: 24), // Đệm dưới cùng cho đẹp
                    ],
                  ),
                ),
              ),
...
// ✅ Enum thay vì magic number int (0, 1, 2)
enum _MenuAction {
  open,
  edit,
  delete;
...
// ✅ Row tái sử dụng cho cả 3 menu item
